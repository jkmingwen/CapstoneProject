...
% Need to consider cost as a factor --- or rather, talk about the purpose of the project: is it scientific or commerical?
% Explain why the factors I'm considering are important for my project
...
From the considerations above, the choice of SBC for this project was narrowed down to the Jetson TX2, the HiKey 970, and the Odroid XU4. Out of these three SBCs, the Odroid XU4 has the smallest dimensions. More importantly, while the Jetson TX2 and the HiKey 970 both have higher processing powers compared to the Odroid XU4, they both cost considerably more than the Odroid XU4. The Jetson TX2 and the HiKey 970 cost \$569 and \$299 respectively. The Odroid XU4, on the other hand, currently costs \$49. Therefore, due to its portability and its affordability, the Odroid XU4 was chosen as the SBC to implement the video synthesizer on.
\end{document}
%%% Local Variables:
%%% mode: latex
